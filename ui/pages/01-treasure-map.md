...
- 浅色底图：浅灰白底色，柔和的绿色公园/植被区域，浅灰道路，细线建筑轮廓
...
- 任务宝箱（新增）：🎯 34px，外圈项圈色光环脉冲，下方 "任务奖励" 标注
...
- 白色 90% 不透明度，backdrop-blur 12px，圆角 12px
- 🐾 图标用项圈色，底部 3px 进度条用项圈色
- 三种状态：
  - 未开始："🐾 今日寻宝任务 ▸"
...
### 任务卡片（Bottom Sheet，新增）
- 从底部滑出，约屏幕 1/3 高度
- 标题 "今日寻宝任务" + 右上角进度 "1/3"
- 3 个任务项：复选框（项圈色填充）+ 任务名 + 实时进度 + 奖励
- "出发"按钮（仅未开始时）：项圈色渐变背景，白字
...
全屏 Apple Maps 风格地图为主体，所有 UI 元素以毛玻璃浮层覆盖其上，营造沉浸式探索感。宝箱通过弹跳、发光、粒子等微动画传递"可交互"和"奖励"的反馈。项圈色作为个性化视觉线索贯穿任务条、活动按钮和任务宝箱。整体克制，不喧宾夺主于地图本身。
